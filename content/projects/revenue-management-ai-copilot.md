---
category: "prototype"
title: "LLM Decision Assistant"
titleZh: "LLM 决策助手"
titleEn: "LLM Decision Assistant"
...
applicationZh: "定价、库存、供应链与运营优化"
applicationEn: "Pricing, Inventory, Supply Chain, and Operations Optimization"
...
pipelineZh:
  ...
  - "数据库查询或预测 / 优化算法调用"
  - "证据、参数、约束与计算链路聚合"
  - "可解释回答、What-if 对比与决策建议"
pipelineEn:
  - "Natural-language question and business-intent parsing"
  - "Knowledge retrieval, semantic registry, and tool selection"
  - "Database queries or forecasting / optimization tool calls"
  - "Aggregation of evidence, parameters, constraints, and calculation lineage"
  - "Grounded explanations, what-if comparisons, and decision support"
highlightsZh:
  - "回答基于真实数据和算法调用结果生成，降低大模型脱离业务事实的风险"
  - "从最终价格反向追溯购买概率、WTP、Bid Price、需求预测及输入数据"
  - "支持修改需求、容量、参数或约束后重新求解，并比较决策变化"
  - "将 Explain、What-if、Debug 与 Constraint 统一为面向算法系统的交互层"
highlightsEn:
  - "Ground answers in real data and algorithm outputs to reduce unsupported model responses"
