---
category: "core"
title: "Simulation & Algorithm Evaluation Platform"
titleZh: "仿真与算法评测平台"
titleEn: "Simulation & Algorithm Evaluation Platform"
description: "A controlled simulation and benchmarking environment for evaluating pricing and optimization algorithms under realistic demand uncertainty."
descriptionZh: "从0到1搭建可控、可复现的实验环境，在真实需求不确定性下评测定价与优化算法，贯通用户生成、选择与取消、预测、优化、控制和收益分解。"
descriptionEn: "Built a controlled and reproducible environment for evaluating pricing and optimization algorithms under realistic demand uncertainty, spanning customer generation, choice and cancellation, forecasting, optimization, control, and value decomposition."
applicationZh: "航空收益管理"
applicationEn: "Airline Revenue Management"
